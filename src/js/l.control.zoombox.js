...
L.Control.BoxZoom = L.Control.extend({
  options: {
    ...
    aspectRatio: null,
    divClasses: 'leaflet-control-boxzoom leaflet-bar leaflet-control',
  ...
  onAdd: function (map) {
    ...
    this.controlDiv.innerHTML = '<a class="leaflet-control-zoombox-button leaflet-bar-part" href="#" title="View zoombox"></a>'
